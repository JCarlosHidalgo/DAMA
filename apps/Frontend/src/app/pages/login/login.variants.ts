...
export const loginStyles = tv({
  slots: {
    ...
    brandMark:
      'grid h-10 w-10 place-items-center rounded-[var(--dama-radius)] bg-primary text-[18px] font-bold tracking-[-0.02em] text-primary-fg shadow-[var(--dama-shadow-sm)]',
    ...
    card: 'w-full max-w-[420px] p-3 shadow-[var(--dama-shadow-lg)]!',
