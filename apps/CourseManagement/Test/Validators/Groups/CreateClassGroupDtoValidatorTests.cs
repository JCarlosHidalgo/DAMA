...
[TestFixture]
public class CreateClassGroupDtoValidatorTests
{
    private CreateClassGroupDtoValidator _validator = null!;

    [SetUp]
    public void SetUp() => _validator = new CreateClassGroupDtoValidator();

    [Test]
    public async Task Validate_WithValidPayload_IsValid()
    {
        var request = new CreateClassGroupDto { Name = "Grupo Demo" };
    ...
    {
        var request = new CreateClassGroupDto { Name = string.Empty };
    ...
    {
        var request = new CreateClassGroupDto { Name = new string('a', 201) };
