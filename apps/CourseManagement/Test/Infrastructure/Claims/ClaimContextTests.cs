...
public class ClaimContextTests
{
    ...
    [SetUp]
    public void SetUp() => httpContextAccessor = new Mock<IHttpContextAccessor>(MockBehavior.Strict);
    ...
    public void TenantId_WhenClaimPresentAndValid_ReturnsParsedGuid()
    {
        ...
        var claimContext = new ClaimContext(httpContextAccessor.Object);
    ...
    public void TenantId_CachesValueAcrossMultipleReads()
    {
        ...
        httpContextAccessor.Verify(accessor => accessor.HttpContext, Times.Once);
    }
