...
public class CreateUniqueClassDtoValidator : AbstractValidator<CreateUniqueClassDto>
{
    ...
    public CreateUniqueClassDtoValidator()
    {
        ...
        RuleFor(uniqueClass => uniqueClass.ExternalReference)
            .MaximumLength(128).WithMessage(TooLongExternalReferenceMessage)
            .When(uniqueClass => uniqueClass.ExternalReference != null);
    }
}
