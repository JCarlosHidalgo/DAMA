...
public interface IQrPaymentCreationBuilder
{
    ...
    RegisterDebtRequest BuildTodotixRequest(Guid debtIdentifier, string? email, DebtTemplate template, string tenantTimezone, string description, DateTime expiresAtUtc);
