...
{
    private CreateTenantDtoValidator _sut = null!;

    [SetUp]
    public void SetUp() => _sut = new CreateTenantDtoValidator();

    [Test]
    public async Task Validate_WithValidName_IsValid()
    {
        CreateTenantDto tenant = new() { Name = "Sample Tenant" };
    ...
    {
        CreateTenantDto tenant = new() { Name = string.Empty };
    ...
    {
        CreateTenantDto tenant = new() { Name = new string('a', 201) };
