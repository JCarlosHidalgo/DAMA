...
public sealed class CourseDeletedConsumer : BackgroundService
{
    ...
    protected override async Task ExecuteAsync(CancellationToken cancellationToken)
    {
        ...
        while (!cancellationToken.IsCancellationRequested)
        {
            ...
            {
                LogEvents.ConsumerConnectionError(_logger, consumerException, "CourseDeletedConsumer");
        ...
        CancellationToken cancellationToken)
    {
        ...
        try
        {
            ...
            LogEvents.ConsumerSubscribed(_logger, "CourseDeletedConsumer", topologyDescriptor.QueueName);
